...
class ServiceDefinition extends Component {
    ...
    render () {
        ...
        return (
            ...
            >
                <div className="ServiceDefinition">
                    <div className="col span-1-of-2">
                        {data}
                    </div>
                    <div className="col span-1-of-2">
                        <ServiceUsers userList={this.state.serviceUsers} 
                            filterUser={this.state.filterUser} 
                            filteredUsersResult={this.state.filterUsersResult} 
                            removeUserClickHandler={this.removeUserClickHandler}
                            addUserClickHandler={this.addUserClickHandler}
                            filterChangedHandler={this.filterChangedHandler}
...
export default connect(mapStateToProps, mapDispatchToProps)(withErrorHandler(ServiceDefinition));